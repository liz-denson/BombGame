...
# the LCD display GUI
class Lcd(Frame):
    def __init__(self, window, phases):
        ...
        self.setupBoot()
        # stores the phase objects
        self._phases = phases
        # stores the strikes count
        self._strikes = 0
        # stores the max strike count
        self._max_strikes = 5
    ...
    def setup(self):
        ...
        if (SHOW_BUTTONS):
            ...
            self._bpause = tkinter.Button(self, bg="green", fg="black", font=("Courier New", 18), text="Pause", anchor=CENTER, command=self.pause)
